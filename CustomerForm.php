  ...
  <img src="images/driverless-cars-history-share.jpg" class="imgdchs">
    			...
    			<!-- <div class="col-md-6">
                    <div class="map-responsive">
                        <iframe src="https://www.google.com/maps/embed/v1/place?key=getenv('GOOGLE_API_KEY')" width="600" height="450" frameborder="0" style="border:0; width: 100%;" allowfullscreen></iframe>
                    </div>
    			</div> -->
    		</div>
    	</div>
